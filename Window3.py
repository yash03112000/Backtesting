...
class Window3:
	...
	def __init__(self):
		...
		self.headLabel = tk.Label(self.root,text = 'Exit Conditions', font = ('calibre',10,'bold'))
		...
		self.AddBtn = tk.Button(self.root,text='Add Exit Condition',command=self.addEntryCondition)
